#!/usr/bin/env python3
"""
import_wayback_2324.py — Imports wayback_2324_raw.json into futbolbase.db.

Only touches season 2023-2024. Does NOT modify 2024-2025 or 2025-2026 data.
...
RAW_PATH = os.path.join(os.path.dirname(os.path.abspath(__file__)), "wayback_2324_raw.json")
...
def main():
    if not os.path.exists(RAW_PATH):
        print(f"ERROR: {RAW_PATH} not found. Run fetch_wayback_2324.py first.")
        sys.exit(1)
